...
auction_admin_site.register(ProductImage, ImageAdmin)
auction_admin_site.register(AuctionLot, AuctionAdmin)
auction_admin_site.register(AuctionHistory, AuctionHistoryAdmin)