...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        if ($("#bid_counter1").length) {
            ...
            const no_winner_element = document.querySelector("#no-winner-title");
            ...
            let myCountDown = new ysCountDown(endDate, function (remaining, finished) {
                ...
                if (finished) {
                    ...
                    if (no_winner_element) {
                        no_winner_element.setAttribute("style", "display: block;");
                    }
                } else {
                    var re_days = remaining.totalDays;
                    var re_hours = remaining.hours;
                    message += re_days + gettext(" days : ");
                    message += re_hours + gettext(" hours : ");
                    message += remaining.minutes + gettext(" minutes : ");
                    message += remaining.seconds + gettext(" seconds");
                }
        ...
        if ($("#bid_counter36").length) {
            // If you need specific date then comment out 1 and comment in 2
            // let endDate = "2020/03/20"; //This is 1
            let endDate = (new Date().getFullYear()) + '/' + (new Date().getMonth() + 1) + '/' + (new Date().getDate() + 1); //This is 2
            let counterElement = document.querySelector("#bid_counter36");
            let myCountDown = new ysCountDown(endDate, function (remaining, finished) {
                let message = "";
                if (finished) {
                    message = gettext("Expired");
        ...
        if ($("#bid_counter37").length) {
            // If you need specific date then comment out 1 and comment in 2
            // let endDate = "2020/03/20"; //This is 1
            let endDate = (new Date().getFullYear()) + '/' + (new Date().getMonth() + 1) + '/' + (new Date().getDate() + 1); //This is 2
            let counterElement = document.querySelector("#bid_counter37");
            let myCountDown = new ysCountDown(endDate, function (remaining, finished) {
                let message = "";
                if (finished) {
                    message = gettext("Expired");
        ...
        if ($("#bid_counter38").length) {
            // If you need specific date then comment out 1 and comment in 2
            // let endDate = "2020/03/20"; //This is 1
            let endDate = (new Date().getFullYear()) + '/' + (new Date().getMonth() + 1) + '/' + (new Date().getDate() + 1); //This is 2
            let counterElement = document.querySelector("#bid_counter38");
            let myCountDown = new ysCountDown(endDate, function (remaining, finished) {
                let message = "";
                if (finished) {
                    message = gettext("Expired");
        ...
        if ($("#min_counter_1").length) {
            ...
            // let endDate = "2020/03/20"; //This is 1
            let endDate = (new Date().getFullYear()) + '/' + (new Date().getMonth() + 1) + '/' + (new Date().getDate() + 1); //This is 2
            let counterElement = document.querySelector("#min_counter_16");
            let myCountDown = new ysCountDown(endDate, function (remaining, finished) {
                let message = "";
                if (finished) {
                    message = gettext("Ended.");
        ...
        if ($("#min_counter_1").length) {
            ...
            // let endDate = "2020/03/20"; //This is 1
            let endDate = (new Date().getFullYear()) + '/' + (new Date().getMonth() + 1) + '/' + (new Date().getDate() + 1); //This is 2
            let counterElement = document.querySelector("#min_counter_17");
            let myCountDown = new ysCountDown(endDate, function (remaining, finished) {
                let message = "";
                if (finished) {
                    message = gettext("Ended.");
        ...
        if ($("#min_counter_1").length) {
            ...
            // let endDate = "2020/03/20"; //This is 1
            let endDate = (new Date().getFullYear()) + '/' + (new Date().getMonth() + 1) + '/' + (new Date().getDate() + 1); //This is 2
            let counterElement = document.querySelector("#min_counter_18");
            let myCountDown = new ysCountDown(endDate, function (remaining, finished) {
                let message = "";
                if (finished) {
                    message = gettext("Ended.");
        ...
        if ($("#min_counter_1").length) {
            ...
            // let endDate = "2020/03/20"; //This is 1
            let endDate = (new Date().getFullYear()) + '/' + (new Date().getMonth() + 1) + '/' + (new Date().getDate() + 1); //This is 2
            let counterElement = document.querySelector("#min_counter_19");
            let myCountDown = new ysCountDown(endDate, function (remaining, finished) {
                let message = "";
                if (finished) {
                    message = gettext("Ended.");
        ...
        if ($("#min_counter_1").length) {
            ...
            // let endDate = "2020/03/20"; //This is 1
            let endDate = (new Date().getFullYear()) + '/' + (new Date().getMonth() + 1) + '/' + (new Date().getDate() + 1); //This is 2
            let counterElement = document.querySelector("#min_counter_20");
            let myCountDown = new ysCountDown(endDate, function (remaining, finished) {
                let message = "";
                // Tat thong bao hien thi khong co nguoi chien thang
                if (finished) {
                    message = gettext("Ended.");
                } else {
                    var re_days = remaining.totalDays;
        ...
        if ($("#min_counter_1").length) {
            ...
            // let endDate = "2020/03/20"; //This is 1
            let endDate = (new Date().getFullYear()) + '/' + (new Date().getMonth() + 1) + '/' + (new Date().getDate() + 1); //This is 2
            let counterElement = document.querySelector("#min_counter_21");
            let myCountDown = new ysCountDown(endDate, function (remaining, finished) {
                let message = "";
                if (finished) {
                    message = gettext("Ended.");
        ...
        if ($("#min_counter_1").length) {
            ...
            // let endDate = "2020/03/20"; //This is 1
            let endDate = (new Date().getFullYear()) + '/' + (new Date().getMonth() + 1) + '/' + (new Date().getDate() + 1); //This is 2
            let counterElement = document.querySelector("#min_counter_22");
            let myCountDown = new ysCountDown(endDate, function (remaining, finished) {
                let message = "";
                if (finished) {
                    message = gettext("Ended.");
        ...
        if ($("#min_counter_1").length) {
            ...
            // let endDate = "2020/03/20"; //This is 1
            let endDate = (new Date().getFullYear()) + '/' + (new Date().getMonth() + 1) + '/' + (new Date().getDate() + 1); //This is 2
            let counterElement = document.querySelector("#min_counter_23");
            let myCountDown = new ysCountDown(endDate, function (remaining, finished) {
                let message = "";
                if (finished) {
                    message = gettext("Ended.");
        ...
        if ($("#min_counter_1").length) {
            ...
            // let endDate = "2020/03/20"; //This is 1
            let endDate = (new Date().getFullYear()) + '/' + (new Date().getMonth() + 1) + '/' + (new Date().getDate() + 1); //This is 2
            let counterElement = document.querySelector("#min_counter_24");
            let myCountDown = new ysCountDown(endDate, function (remaining, finished) {
                let message = "";
                if (finished) {
                    message = gettext("Ended.");
        ...
        if ($("#min_counter_1").length) {
            ...
            // let endDate = "2020/03/20"; //This is 1
            let endDate = (new Date().getFullYear()) + '/' + (new Date().getMonth() + 1) + '/' + (new Date().getDate() + 1); //This is 2
            let counterElement = document.querySelector("#min_counter_25");
            let myCountDown = new ysCountDown(endDate, function (remaining, finished) {
                let message = "";
                if (finished) {
                    message = gettext("Ended.");
